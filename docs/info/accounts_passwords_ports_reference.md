...
| 8080 | GPUStack 管理 | HTTP | 🟢 运行中 | `http://localhost:8080` | GPU管理平台 |
...
| GPUStack | admin | Lsy2025@ | 管理员 | `http://localhost:8080` | ✅ 活跃 |
...
| 用户名 | 密码 | 端口 | 访问地址 | 说明 |
|--------|------|------|----------|------|
| admin | Lsy2025@ | 8080 | `http://localhost:8080` | GPU管理界面 |
