    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "version",
                    models.CharField(
                        default="1.0.0", max_length=50, verbose_name="当前版本"
                    ),
                ),
                (
                    "components",
                ...
                (
                    "deployment_count",
                    models.PositiveIntegerField(default=0, verbose_name="部署次数"),
                ),
            ],
            options={
                "verbose_name": "AI应用",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dockerfile",
                    models.TextField(blank=True, verbose_name="Dockerfile内容"),
                ),
                ("requirements", models.TextField(blank=True, verbose_name="依赖要求")),
                (
                    "image_url",
                    models.CharField(
                        blank=True, max_length=500, verbose_name="镜像地址"
                    ),
                ),
                (
                    "manifest",
                    models.JSONField(default=dict, verbose_name="Kubernetes清单"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="service_platform.application",
                        verbose_name="应用",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "path",
                    models.CharField(default="/", max_length=500, verbose_name="路径"),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    "health_check_path",
                    models.CharField(
                        default="/health", max_length=200, verbose_name="健康检查路径"
                    ),
                ),
                (
                    "last_health_check",
                ...
                (
                    "is_healthy",
                    models.BooleanField(default=False, verbose_name="是否健康"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="service_platform.applicationversion",
                        verbose_name="应用版本",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "config_schema",
                    models.JSONField(default=dict, verbose_name="配置模式"),
                ),
                (
                    "default_config",
                ...
                (
                    "dockerfile_template",
                    models.TextField(verbose_name="Dockerfile模板"),
                ),
                (
                    "manifest_template",
                    models.JSONField(default=dict, verbose_name="Kubernetes清单模板"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="service_platform.servicecategory",
                verbose_name="分类",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "request_count",
                    models.PositiveIntegerField(default=0, verbose_name="请求数"),
                ),
                (
                    "error_count",
                ...
                (
                    "network_in",
                    models.FloatField(default=0, verbose_name="网络入流量(MB)"),
                ),
                (
                    "network_out",
                    models.FloatField(default=0, verbose_name="网络出流量(MB)"),
                ),
                (
                    "custom_metrics",
                    models.JSONField(default=dict, verbose_name="自定义指标"),
                ),
                (
                    "timestamp",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="service_platform.serviceendpoint",
                        verbose_name="服务端点",
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="service_pla_endpoin_ce240e_idx",
                    ),
                    models.Index(
                        fields=["-timestamp"], name="service_pla_timesta_91fb1d_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="service_pla_status_3061d5_idx",
                    ),
                    models.Index(
                        fields=["level", "-triggered_at"],
                        name="service_pla_level_322d7e_idx",
                    ),
                ],
            },
        ),
